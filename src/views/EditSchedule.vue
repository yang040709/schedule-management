...
const initValueFn = () => {
  return {
    ...
    priority: schedule.value?.priority || 'high',
    completed: schedule.value?.completed || false,
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden p-4 sm:p-6 lg:p-8">
      ...
      <div class="p-6 sm:p-8">
        ...
        <form @submit="onSubmit" class="space-y-5">
          ...
          <div class="pt-4">
            <Button type="submit"
              class="w-full h-12 text-white font-medium rounded-lg transition-all transform hover:scale-[1.02] active:scale-[0.98]">修改</Button>
          </div>
        </form>
      </div>
    </div>
