...
<template>
  <div class="w-full max-w-3xl mx-auto">
    ...
    <div v-if="totalCount === 0" class="rounded-2xl bg-white py-14 text-center shadow-sm ring-1 ring-gray-100">
    ...
    <div v-else-if="totalCount !== 0 && events.length === 0"
    ...
    <div v-else class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
      <div class="divide-y divide-gray-100">
        <div class="p-4 sm:p-5" v-for="ev in events" :key="ev.id">
          <ScheduleItem :event="ev" @toggle-complete="handleToggleComplete" @edit="handleEdit" @delete="handleDelete" />
        </div>
      </div>
    </div>
  </div>
