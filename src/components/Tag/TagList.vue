...
<template>
  <div class="flex flex-wrap gap-2">
    <Tag text="全部" :is-active="currentActiveTag === '全部' ? true : false" @click="setCurrentActiveTag('全部')" />
    <Tag v-for="item in tagStore.tags" :is-active="item === currentActiveTag ? true : false" :text="item"
